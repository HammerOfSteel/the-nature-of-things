/// POC: Enhanced top-down 2D renderer.
/// Run with: cargo run --bin poc_2d
...
use the_nature_of_things::render::draw_enhanced::{draw_world_enhanced, actor_at_screen_enh};
...
fn window_conf() -> Conf {
    Conf {
        window_title: "The Nature of Things — Enhanced 2D POC".to_owned(),
    ...
    loop {
        ...
        if is_mouse_button_pressed(MouseButton::Left) {
            ...
            if mx < VIEWPORT_WIDTH {
                gs.selected_actor =
                    actor_at_screen_enh(&gs.world.actors, mx, my, gs.cam_x, gs.cam_y);
            }
        }
        ...
        draw_world_enhanced(&gs.world, gs.selected_actor, gs.cam_x, gs.cam_y);
        ...
        let fps_str = format!("POC: Enhanced 2D   FPS:{:.0}  Day {}  {}",
